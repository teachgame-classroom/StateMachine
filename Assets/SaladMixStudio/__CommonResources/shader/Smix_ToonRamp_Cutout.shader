    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(saturate((_MainTex_var.a+(_AlphaCutoff*1.0+-0.5))) - 0.5);
